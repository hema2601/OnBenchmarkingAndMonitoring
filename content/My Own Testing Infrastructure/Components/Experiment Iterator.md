...
The `run_exp` function is called by the [[Setup Iterator]]. It requires the name of the experiment, how often each experiment should be run, the number of connection increases, whether or not the connection should be increased exponentially, and what meta-experiment the experiment belongs to.
...
After the experiment is done, it moves it into the meta-experiment folder to keep the `data/` directory clean.
